...
class SmcStructureDistanceTests(unittest.TestCase):
    def test_15m_eurusd_threshold_and_reference(self):
        gate = StructureDistanceGate(timeframe="15m", point_size=0.00001)
        self.assertTrue(gate.accept(1.10000))
        self.assertFalse(gate.accept(1.10099))
        self.assertEqual(gate.last_accepted_level, 1.10000)
        self.assertFalse(gate.accept(1.10075))
        self.assertEqual(gate.last_accepted_level, 1.10000)
    ...
    def test_15m_xauusd_uses_symbol_tick_size(self):
        ...
        self.assertFalse(gate.accept(2500.99))
